...
MUSIC_BOT_NAME = getenv("MUSIC_BOT_NAME", "𓏺 BoT 𝗌𝖴𝖽𝖺𝖡𝖾𝖪 . ")
PROTECT_CONTENT = getenv("PROTECT_CONTENT", "True")
OWNER_ID = list(map(int, getenv("OWNER_ID", "2045197179").split()))
HEROKU_API_KEY = getenv("HEROKU_API_KEY")
HEROKU_APP_NAME = getenv("HEROKU_APP_NAME")
UPSTREAM_REPO = getenv("UPSTREAM_REPO","https://github.com/fps90/Hot")
UPSTREAM_BRANCH = getenv("UPSTREAM_BRANCH", "master")
GIT_TOKEN = getenv("GIT_TOKEN","")
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/zzzii")
SUPPORT_GROUP = getenv("SUPPORT_GROUP", "https://t.me/zzzii") 
